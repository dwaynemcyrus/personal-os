# Schema Reference 3.0 — Personal OS
**Version:** 3.0
**Date:** 2026-04-01
...
The following subtypes carry the `resources` frontmatter field:

**creation:** all subtypes
...
The following subtypes do NOT carry `resources`:
**reference:** slip, literature, source, quote, identity, contact, offer, asset, software, course
...
They are now unified under `creation` since all are documents you author and develop.
Use the `format` field to distinguish delivery context.
A `delivered` boolean or `date_delivered` field marks when transmission occurred.
...
*End of schema reference. Version 3.0 — 2026-04-01*